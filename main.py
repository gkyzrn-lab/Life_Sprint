...
_try_include("api.router_tutorial",                 prefix_label="tutorial")
_try_include("api.router_difficulty",               prefix_label="difficulty")
...
_try_include("api.router_career_recommendations",   prefix_label="career-recommendations")
_try_include("api.router_market_intelligence",      prefix_label="market-intelligence")
...
_try_include("api.router_mentorship",               prefix_label="mentorship")
_try_include("api.router_community",                prefix_label="community")
_try_include("api.router_analytics",                prefix_label="analytics")
